...
import { CheckCircle2, Phone, ArrowRight, Shield, Umbrella, Zap, UserCheck } from 'lucide-react';
...
export default function PricingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      icon: <Umbrella className="w-8 h-8 text-blue-400" />
    },
    {
      id: 3,
      name: "Premium",
  ...
  return (
    <div className="bg-gradient-to-br from-neutral-900 via-slate-900 to-neutral-800 min-h-screen">
      ...
      {/* PRICING CARDS - PERFECT SPACING & GLASSMORPHISM */}
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <div
              key={plan.id}
              className={`
                relative rounded-3xl border backdrop-blur-xl shadow-2xl transition-all duration-500 hover:scale-[1.02]
                ${plan.popular 
                  ? "ring-2 ring-emerald-400/50 scale-[1.03] md:-translate-y-6 shadow-emerald-500/20" 
                  : "shadow-black/20"
                }
                ${plan.cardClass}
              `}
            >
              ...
              <div className="p-8">
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-base text-gray-400 mb-4">{plan.subtitle}</p>
                  ...
                  <p className="text-sm text-gray-400 mb-6">One-time payment • Free installation</p>
