...
export default function PricingPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-neutral-900 via-slate-900 to-neutral-800 min-h-screen">
      ...
      {/* PRICING CARDS - PERFECT HORIZONTAL BALANCE */}
            ...
            >
              ...
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="bg-gradient-to-r from-emerald-500 to-cyan-500 text-white px-5 py-1.5 rounded-full text-xs font-semibold shadow-lg">
                    ⭐ Most Popular
                  </div>
                </div>
              )}
