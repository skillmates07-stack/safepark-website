...
export default function ContactPage() {
  ...
  return (
    <div className="scroll-smooth bg-gradient-to-br from-[#0f172a] via-[#0f2d2a] to-[#052e16] min-h-screen pt-20">
      ...
      <section className="pt-20 pb-16 px-6 md:px-12 lg:px-20">
      ...
      {/* MAIN CONTACT SECTION - PERFECT BALANCE */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="bg-gradient-to-br from-gray-900/70 to-gray-800/80 backdrop-blur-xl rounded-3xl p-10 shadow-2xl border border-gray-700/50">
                {!isSubmitted ? (
                  <>
                    <div className="mb-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-6 py-4 bg-gray-800/60 border border-gray-600/40 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all text-lg"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleChange}
                          className="w-full px-6 py-4 bg-gray-800/60 border border-gray-600/40 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all text-lg resize-none"
                  ...
                  <div className="text-center py-20">
                    ...
                    <h3 className="text-4xl font-bold text-white mb-6">Thank You!</h3>
                    ...
                    <div className="flex gap-6 justify-center">
                      <a 
                        ...
                        className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 hover:scale-105"
                      >
                        Call Us Now
                      </a>
                      <a 
                        href="https://wa.me/919600840058" 
                        className="border-2 border-emerald-400 text-emerald-400 hover:bg-emerald-400 hover:text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 hover:scale-105"
                      >
                        WhatsApp
                      </a>
                    </div>
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              {/* Service Promise */}
              <div className="bg-gradient-to-br from-emerald-900/50 to-emerald-800/60 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-emerald-700/50">
                ...
                <ul className="space-y-4 text-emerald-100">
                  ...
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-6 h-6 text-emerald-400" />
                    <span className="text-lg">2-year warranty included</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-6 h-6 text-emerald-400" />
