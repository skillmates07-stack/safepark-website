...
import { Droplets, Users, Award, Shield, Phone, ArrowRight } from 'lucide-react';
...
export default function FeaturesPage() {
  return (
    <div className="scroll-smooth bg-gradient-to-br from-[#0f172a] via-[#0f2d2a] to-[#052e16] min-h-screen pt-20">
      ...
      {/* MAIN FEATURES GRID - REDUCED SPACING */}
      <section className="py-12 px-6 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto space-y-16">
          
          {/* Feature 1 - All-Weather Protection */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="group">
              <div className="bg-gradient-to-br from-blue-900/30 to-blue-800/50 backdrop-blur-xl rounded-3xl p-10 border border-blue-700/30 shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:scale-[1.02]">
                <div className="w-16 h-16 bg-blue-500/20 rounded-3xl flex items-center justify-center mb-6 group-hover:bg-blue-500/30 transition-all">
                  <Droplets className="w-8 h-8 text-blue-400" />
                </div>
                <h3 className="text-3xl font-black text-white mb-4">All-Weather Champion</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="group order-1 md:order-2">
              <div className="bg-gradient-to-br from-green-900/30 to-green-800/50 backdrop-blur-xl rounded-3xl p-10 border border-green-700/30 shadow-2xl hover:shadow-green-500/20 transition-all duration-500 hover:scale-[1.02]">
                <div className="w-16 h-16 bg-green-500/20 rounded-3xl flex items-center justify-center mb-6 group-hover:bg-green-500/30 transition-all">
                  <Users className="w-8 h-8 text-green-400" />
                </div>
                <h3 className="text-3xl font-black text-white mb-4">Family-First Design</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/50 backdrop-blur-xl rounded-3xl p-10 border border-purple-700/30 shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 hover:scale-[1.02]">
                <div className="w-16 h-16 bg-purple-500/20 rounded-3xl flex items-center justify-center mb-6 group-hover:bg-purple-500/30 transition-all">
                  <Award className="w-8 h-8 text-purple-400" />
                </div>
                <h3 className="text-3xl font-black text-white mb-4">Professional Excellence</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="text-center bg-gray-900/50 backdrop-blur rounded-2xl p-6 hover:scale-105 transition-all duration-300">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              ...
              className="bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 shadow-2xl hover:shadow-emerald-500/30 hover:scale-105 inline-flex items-center justify-center gap-3"
            >
            ...
            <a 
              ...
              className="border-2 border-emerald-400 text-emerald-400 hover:bg-emerald-400 hover:text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 hover:scale-105 inline-flex items-center justify-center gap-3"
            >
