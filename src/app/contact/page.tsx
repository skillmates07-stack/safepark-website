...
export default function ContactPage() {
  ...
  return (
    <div className="scroll-smooth bg-gradient-to-br from-[#0f172a] via-[#0f2d2a] to-[#052e16] min-h-screen pt-20">
      ...
      <section className="pt-12 pb-10 px-6 md:px-12 lg:px-20">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-3">
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-800/70 backdrop-blur-xl rounded-2xl p-6 shadow-2xl border border-gray-700/50">
                {!isSubmitted ? (
                  <>
                    <div className="mb-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 bg-gray-800/60 border border-gray-600/40 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-3 bg-gray-800/60 border border-gray-600/40 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all resize-none"
                      ...
                      <button
                        type="submit"
                        className="w-full bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white px-6 py-3 rounded-lg font-bold transition-all duration-300 hover:scale-[1.02] shadow-lg hover:shadow-emerald-500/30 flex items-center justify-center gap-2"
                      >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gradient-to-br from-gray-900/60 to-gray-800/70 backdrop-blur-xl rounded-2xl p-6 shadow-2xl border border-gray-700/50">
                ...
                <div className="space-y-4">
                  <a href="tel:+919600840058" className="flex items-center gap-3 group">
                    ...
                    <div>
                      <h4 className="font-bold text-white text-sm">Call Now</h4>
              ...
              {/* Service Promise */}
              <div className="bg-gradient-to-br from-emerald-900/40 to-emerald-800/50 backdrop-blur-xl rounded-2xl p-6 shadow-2xl border border-emerald-700/50">
