...
export default function HomePage() {
  return (
    <div className="scroll-smooth bg-gradient-to-br from-[#0f172a] via-[#0f2d2a] to-[#052e16] min-h-screen">
      ...
      <section className="pt-28 pb-20 px-6 md:px-12 lg:px-20 min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            
            {/* Left Content */}
            <div className="text-center md:text-left">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-emerald-100/10 border border-emerald-400/20 text-emerald-300 font-medium text-sm backdrop-blur-sm mb-8">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white mb-8">
                Everyday Risks.
                <span className="block bg-gradient-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent mt-4">
                  Lasting Protection.
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <a 
                  ...
                  className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl font-bold hover:scale-105 hover:shadow-lg transition-all duration-300 inline-flex items-center justify-center gap-2 h-16"
                >
                ...
                <a 
                  ...
                  className="border-2 border-emerald-400 text-emerald-400 hover:bg-emerald-400 hover:text-white px-8 py-4 rounded-xl font-bold hover:scale-105 hover:shadow-lg transition-all duration-300 inline-flex items-center justify-center gap-2 h-16"
                >
                  View Gallery
      ...
      {/* FEATURES SECTION - PROPER HEIGHT */}
      <section className="py-20 px-6 md:px-12 lg:px-20 relative min-h-screen flex items-center">
        ...
        <div className="max-w-6xl mx-auto relative z-10 w-full">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                {/* Glass Card */}
                <div className="relative bg-white/[0.06] backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl text-center transition-all duration-500 hover:scale-105 hover:bg-white/[0.10] hover:shadow-emerald-500/20 min-h-[280px] flex flex-col justify-between">
                  ...
                  <p className="text-gray-400 leading-relaxed text-base relative z-10">{feature.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* WHY CHOOSE SECTION - PROPER HEIGHT */}
      <section className="py-20 px-6 md:px-12 lg:px-20 relative min-h-screen flex items-center">
        {/* Background Glass Effect */}
        ...
        <div className="max-w-6xl mx-auto relative z-10 w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                {/* Glass Card */}
                <div className="relative bg-white/[0.06] backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl text-center transition-all duration-500 hover:scale-105 hover:bg-white/[0.10] hover:shadow-emerald-500/20 min-h-[320px] flex flex-col justify-between">
                  {/* Subtle glow on hover */}
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      ...
      {/* TESTIMONIALS SECTION - PROPER HEIGHT */}
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                {/* Glass Card */}
                <div className="relative bg-white/[0.06] backdrop-blur-xl rounded-2xl p-8 border border-white/20 shadow-xl transition-all duration-500 hover:scale-[1.02] hover:bg-white/[0.10] min-h-[280px]">
                  {/* Subtle inner glow */}
                  ...
                  <div className="relative z-10">
                    ...
                    <blockquote className="leading-relaxed text-gray-300 mb-6 text-base">
                      "{review.text}"
                    </blockquote>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-20 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold leading-tight text-white mb-4">
              Ready to Protect Your Vehicle?
            </h2>
            <p className="text-lg text-emerald-200 leading-relaxed max-w-xl mx-auto">
              Join thousands who chose SafePark for premium protection
            </p>
          </div>
          
          {/* Perfect Glass Container */}
          <div className="relative bg-white/[0.06] backdrop-blur-2xl rounded-2xl border border-white/20 p-10 shadow-2xl">
            
            {/* Contact Icons Row */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
              <div className="text-center group hover:scale-105 transition-all duration-300">
                <div className="w-16 h-16 bg-emerald-500/20 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-emerald-500/30 transition-colors">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="tel:+919600840058" 
                className="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 text-center inline-flex items-center justify-center gap-2"
              >
              ...
              <a 
                ...
                className="bg-white/10 border border-white/30 text-white hover:bg-white/20 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 text-center inline-flex items-center justify-center gap-2"
              >
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div>
              <div className="flex items-center space-x-4 mb-8">
                <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-emerald-400 rounded-2xl flex items-center justify-center text-white font-bold text-xl">
                  S
                </div>
