  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[98vw] max-w-6xl rounded-2xl shadow-xl">
          <nav
            className="flex items-center justify-between w-full px-8 py-3
          ...
          >
            ...
            <nav className="hidden md:flex gap-10 flex-1 justify-center">
              {["Features", "Gallery", "Sizes", "Contact"].map((link) => (
                <a
                  key={link}
        ...
        <main className="pt-[88px] bg-gradient-to-br from-[#191825] to-[#21155c] min-h-[100vh]">
          {/* Subtle animated background using a gradient blob or particles can be added here */}
          {/* Example: <AnimatedBackgroundBlobs /> if you use a lib/component */}
          {children}
        </main>
      </body>
    </html>
